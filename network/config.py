...
antennaPower = 0.15  # average antenna power in watts (src: Energy Saving Game for Massive MIMO)
...
powerAllocBase = 2.
antennaSwitchOpts = [-16, 0, 16]
sleepModeDeltas = [1, 0.69, 0.50, 0.29]
wakeupDelays = [0, 1e-3, 1e-2, 1e-1]
antSwitchEnergy = 0.04  # energy consumption of switch per antenna in Joules
sleepSwitchEnergy = [0.05, 0.01, 0.01, 0.01]  # energy consumption of switching sleep mode in Joules
