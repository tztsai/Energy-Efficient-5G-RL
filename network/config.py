...
sleepSwitchEnergy = [0, 0.01, 0.02, 0.04]  # energy consumption of switching sleep mode in Joules
disconnectEnergy = 0.05  # energy consumption of an early disconnection in Joules
